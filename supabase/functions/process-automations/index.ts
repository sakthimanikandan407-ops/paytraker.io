    ...
    try {
        ...
        if (action === 'new_invoice' && payload.invoice_id) {
            ...
            await sendInvoiceEmail({
                ...
                subject: `Your Invoice ${invoice.invoice_number} from Pay Track`,
                textBody,
                htmlBody,
                pdfBytes,
            ...
            await runWithLimit(batch, 3, async (item: any) => {
                try {
                    ...
                    await sendInvoiceEmail({
                        ...
                        gmailUser,
                        replyTo: replyToEmail,
                        subject: `New Automated Invoice from Pay Track`,
                        textBody,
                        htmlBody,
                        pdfBytes,
            ...
            await runWithLimit(batch, 3, async (item: any) => {
                try {
                    ...
                    await sendInvoiceEmail({
                        ...
                        gmailUser,
                        replyTo: replyToEmail,
                        subject: `Payment Reminder: Invoice ${item.invoice_number} from Pay Track`,
                        textBody,
                        htmlBody,
                        pdfBytes,
