    ...
    return (
        <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500">
            <div className="text-center mb-8 relative group">
                ...
                <h3 className="text-2xl font-black text-white tracking-tight uppercase">Recurring Invoice</h3>
                <p className="text-sm font-bold text-slate-500 mt-2 uppercase tracking-widest">Automatically create and send invoices</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    <div>
                        <label className="block text-xs font-black text-slate-500 uppercase tracking-widest mb-3">Select Client*</label>
                ...
                <div className="space-y-6 p-8 bg-white/5 backdrop-blur-3xl rounded-[2.5rem] border border-white/10 shadow-2xl">
                    <div className="grid grid-cols-2 gap-5">
                        <div>
                            <label className="block text-[10px] font-black text-slate-500 mb-2 uppercase tracking-[0.2em]">Amount</label>
                            <input
                                type="number"
                        ...
                        <div>
                            <label className="block text-[10px] font-black text-slate-500 mb-2 uppercase tracking-[0.2em]">Tax %</label>
                            <input
                                type="number"
                                className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-indigo-400 font-black focus:ring-2 focus:ring-indigo-500/20 outline-none"
                                value={taxRate}
                    ...
                    <div>
                        <label className="block text-[10px] font-black text-slate-500 mb-3 uppercase tracking-[0.2em]">Frequency</label>
                    ...
                    <div>
                        <label className="block text-[10px] font-black text-slate-500 mb-2 uppercase tracking-[0.2em]">Start Date</label>
                        <input
                            type="date"
