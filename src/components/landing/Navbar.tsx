        ...
        <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4">
            <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3 bg-slate-900/50 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl">
                ...
                <div className="hidden md:flex items-center gap-10">
                    ...
                    <a href="#faq" className="text-sm font-bold text-slate-300 hover:text-white transition-colors">FAQ</a>
                </div>

                <div className="flex items-center gap-4">
                    {user ? (
                        <a href="/dashboard" className="px-6 py-2.5 bg-indigo-600 text-white font-bold text-sm rounded-xl hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-600/20 hover:scale-105 active:scale-95 text-center">
                            Go to Dashboard
                        </a>
                    ) : (
                        <>
